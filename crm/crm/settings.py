...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_AWS_NAME'),
        'USER': config('POSTGRES_AWS_USER'),
        'PASSWORD': config('POSTGRES_AWS_PASSWORD'),
        'HOST': config('POSTGRES_AWS_HOST'),
        'PORT': config('POSTGRES_AWS_PORT'),
    }
}
